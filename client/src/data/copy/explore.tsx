...
export const PAGE_DESCRIPTION1 = (
  <FormattedMessage
    ...
    defaultMessage={`
    Welcome to the CEJST+ tool. This tool is a reimagining of the <link1>Climate and Economic Justice Screening Tool (CEJST)</link1> created as part of the <link2>Justice40 initiative</link2> in 2021. CEJST looks for disadvantaged communities by considering various environmental and economic burdens of census tracts. A burden represents one of 8 broad environmental and economic categories of climate change, energy, health, housing, legacy pollution, transportation, water and wastewater, and workforce development. Each burden category has between 2-5 associated indicators.
  `}
    description={
