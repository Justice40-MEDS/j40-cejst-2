...
export const PAGE = defineMessages({
  TITLE: {
    ...
    description:
      'Navigate to the methodology page. This is the methodology page title text',
  },
  HEADING: {
    id: 'methodology.page.header.text',
    defaultMessage: 'Methodology',
    description:
      'Navigate to the methodology page. This is the methodology page header text',
  },
  PARA1: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 1',
  },
  PARA1_BULLET1: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 1, bullet 1',
  },
  PARA1_BULLET2: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 1, bullet 2',
  },
  PARA1_BULLET3: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 1, bullet 3',
  },
  PARA1_BULLET3_2: {
  ...
  PARA1_BULLET4: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 1, bullet 5',
  },
  PARA2: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 2',
  },
  SUB_HEADING_1: {
  ...
  PARA3: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 3',
  },
  PARA4: {
  ...
  PARA5: {
    ...
    `,
    description:
      'Navigate to the methodology page. This is the methodology paragraph 5',
  },
});
...
export const FORMULA = {
  INTRO: (
    ...
    `}
      description={
        'Navigate to the methodology page. This is the methodology page introducing the formula'
      }
    />
  ),
  IF: (
    <FormattedMessage
      ...
      `}
      description={
        'Navigate to the methodology page. This is the first part of the formula used in the methodology'
      }
      values={{
        boldtag: boldFn,
      }}
  ...
  PARA6: (
    ...
    `}
      description={
        'Navigate to the methodology page. This is the methodology paragraph 4'
      }
      values={{
        link1: linkFn(
...
export const CATEGORY = {
  HEADING: (
    <FormattedMessage
      ...
      description={
        'Navigate to the methodology page. Navigate to the category section. This is category heading'
      }
    />
  ),
  ID_AS_DISADV_TEXT: (
    <FormattedMessage
      ...
      defaultMessage={`
      Communities exceed this burden threshold if:
    `}
      description={
        'Navigate to the methodology page. Navigate to the category section. This is category heading'
      }
...
export const CATEGORY_AND_CLAUSE = {
  LOW_INC_65: (
    ...
    `}
      description={
        'Navigate to the methodology page. Navigate to the category section. This is category portion of the formula dealing with lower income'
      }
      values={{
        boldtag: boldFn,
  ...
  `}
      description={
        'Navigate to the methodology page. Navigate to the category section. This is the portion of the formula dealing with higher ed enrollment and high school diploma rate'
      }
      values={{
        boldtag: boldFn,
...
export const CATEGORIES = {
  ...
  ALL: (
    <FormattedMessage
      ...
      description={
        'Navigate to the methodology page. Navigate to the dataset section. This is the portion of the dataset card Used In text for all methodologies'
      }
    />
  ),
  ALL_EXCEPT_WORKFORCE: (
    <FormattedMessage
      ...
      description={
        'Navigate to the methodology page. Navigate to the dataset section. This is the portion of the dataset card Used In text for all methodologies except the workforce development'
      }
    />
  ),
  CLIMATE_CHANGE: {
    METHODOLOGY: (
      <FormattedMessage
        ...
        description={
          'Navigate to the methodology page. Navigate to the dataset section. This is the portion of the dataset card that populates the Used in section for the climate change methodology'
        }
      />
    ),
    TITLE: (
      <FormattedMessage
        ...
        description={
          'Navigate to the methodology page. Navigate to the category section. This will set the category title'
        }
      />
    ),
    IF: (
      <FormattedMessage
        ...
        description={
          'Navigate to the methodology page. Navigate to the category section. This will set the if portion of the formula'
        }
        values={{
          boldtag: boldFn,
  ...
  CLEAN_ENERGY: {
    ...
    IF: (
      <FormattedMessage
        ...
        description={
          'Navigate to the methodology page. Navigate to the category section. This will set the if if portion of the formula'
        }
        values={{
          boldtag: boldFn,
...
export const DATASETS = defineMessages({
  HEADING: {
    ...
    description:
      'Navigate to the Methodology page. This is the section heading of which datasets are used in cumulative score',
  },
  BUTTON_TEXT: {
    id: 'methodology.page.datasetContainer.button.text',
    defaultMessage: 'Share data sources with CEQ',
    description:
      'Navigate to the Methodology page. This is the section heading of which datasets are used in cumulative score with a button labeled: Share data sources with CEQ',
  },
  INFO: {
    ...
    `,
    description:
      'Navigate to the Methodology page. This is the description of the dataset section',
  },
  CENSUS_DISCLAIMER: {
    ...
    `,
    description:
      'Navigate to the Methodology page. This is the disclaimer when using census data',
  },
  ADDITIONAL_HEADING: {
    id: 'methodology.page.datasetContainer.additional.heading',
    defaultMessage: 'Additional Indicators',
    description:
      'Navigate to the Methodology page. This is the additional indicators heading',
  },
  ADDITIONAL_INFO: {
    ...
    description:
      'Navigate to the Methodology page. This is the additional indicator info',
  },
});
...
export const DATASET_CARD_LABELS = defineMessages({
  USED_IN: {
    ...
    description:
      'Navigate to the Methodology page. This is the label associated with explaining the card',
  },
  RESP_PARTY: {
  ...
  SOURCE: {
    ...
    description:
      'Navigate to the Methodology page. This is the label associated with source of the card',
  },
  AVAILABLE_FOR: {
    id: 'methodology.page.datasetCard.available.for',
    defaultMessage: 'Available for: ',
    description:
      'Navigate to the Methodology page. This is the label associated with available for which regions of the card',
  },
  NEW: {
  ...
  UPDATED: {
    ...
    description:
      'Navigate to the Methodology page. This is the label associated with an UPDATED card',
  },
});
...
export const SOURCE_LINKS = {
  CENSUS_ACS_15_19: (
    <FormattedMessage
      ...
      defaultMessage={
        '<link1>American Community Survey</link1> from {date15_19}'
      }
      description={
        'Navigate to the Methodology page. This is the source link for Census ACS'
      }
      values={{
        link1: linkFn(
  ...
  DECENNIAL_CENSUS_20: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for Decennial Census'
      }
      values={{
        link1: linkFn(
  ...
  FEMA_NRI: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for FEMA'
      }
      values={{
        link1: linkFn(
  ...
  DOE_LEAD: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for DOE FEMA'
      }
      values={{
        link1: linkFn(
  ...
  EPA_OAR: (
    ...
    `}
      description={
        'Navigate to the Methodology page. This is the source link for EPA OAR'
      }
      values={{
        link1: linkFn(
  ...
  EPA_NATA: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for EPA NATA'
      }
      values={{
        link1: linkFn(
            'https://www.epa.gov/ejscreen/download-ejscreen-data',
  ...
  DOT_EPA: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for DOT EPA'
      }
      values={{
        link1: linkFn(
            'https://www.epa.gov/ejscreen/download-ejscreen-data',
  ...
  HUD: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for HUD'
      }
      values={{
        link1: linkFn(
  ...
  EPA_TSDF: (
    ...
    `}
      description={
        'Navigate to the Methodology page. This is the source link for EPA TSDF'
      }
      values={{
        link1: linkFn(
  ...
  EPA_CERCLIS: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for EPA CERCLIS'
      }
      values={{
        link1: linkFn(
  ...
  EPA_RMP: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for EPA RMP'
      }
      values={{
        link1: linkFn(
            'https://www.epa.gov/ejscreen/download-ejscreen-data',
  ...
  EPA_RSEI: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for EPA RSEI'
      }
      values={{
        link1: linkFn(
            'https://www.epa.gov/ejscreen/download-ejscreen-data',
  ...
  CDC_PLACES: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for CDC Places'
      }
      values={{
  ...
  CDC_SLEEP: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for CDC Sleep'
      }
      values={{
        link1: linkFn(
            'https://www.cdc.gov/nchs/nvss/usaleep/usaleep.html#data',
            false,
            true,
        ),
  ...
  TRANS_BUR: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for Transportation burdens'
      }
      values={{
        link1: linkFn(
            'https://www.transportation.gov/equity-Justice40#:~:text=Transportation%20access%20disadvantage%20identifies%20communities%20and%20places%20that%20spend%20more%2C%20and%20take%20longer%2C%20to%20get%20where%20they%20need%20to%20go.%20(4)',
            false,
            true,
        ),
        date22: DATE_RANGE.TWENTYTWO,
  ...
  UST_FIND: (
    ...
    `}
      description={
        'Navigate to the Methodology page. This is the source link for UST Find'
      }
      values={{
  ...
  BIA_LAR: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the source link for BIA data'
      }
      values={{
...
export const AVAILABLE_FOR = defineMessages({
  ...
  ALL_US_DC_PR: {
    ...
    description:
      'Methodology page dataset card available for US, DC and Puerto Rico type',
  },
  AS_NMI: {
...
export interface IIndicators {
  ...
  sources: {
    ...
    isUpdated?: boolean;
    availableFor: {
      // Todo remove this and replace with MessageDescriptor when ticket #2000 is fixed
      id: string;
      description: string;
  ...
  // All categories:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the census tract dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for low income'
        }
      />
    ),
    note: (
    ...
    `}
        description={
          'Navigate to the Methodology page. This is the note text for low life expectancy'
        }
        values={{
          boldtag: boldFn,
        }}
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the low income dataset'
        }
      />
    ),
    description: (
  ...
  // Climate change category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the expected agr loss rate income dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for exp agr loss rate'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the exp bld loss income dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for exp bld loss rate'
        }
      />
    ),
    usedIn: CATEGORIES.CLIMATE_CHANGE.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the exp pop loss income dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for exp pop loss rate'
        }
      />
    ),
    note: (
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the NEW Projected flood risk'
        }
      />
    ),
    description: (
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the NEW Projected wildfire risk'
        }
      />
    ),
    description: (
  ...
  // Energy category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the energy burden dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for energy burden'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the pm25 dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for pm 2.5'
        }
      />
    ),
    usedIn: CATEGORIES.CLEAN_ENERGY.METHODOLOGY,
  ...
  // Health category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the asthma dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for asthma'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the diabetes dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for diabetes'
        }
      />
    ),
    usedIn: CATEGORIES.HEALTH_BURDENS.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the heart disease dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for heart disease'
        }
      />
    ),
    usedIn: CATEGORIES.HEALTH_BURDENS.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the life exp dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for low life expectancy'
        }
      />
    ),
    note: (
  ...
  // Housing category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Historic Underinvestment'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Historic Underinvestment'
        }
        values={{
          link1: linkFn(
    ...
    note: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the note text for Historic Underinvestment'
        }
        values={{
          boldtag: boldFn,
        }}
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the house burden dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for housing burden'
        }
      />
    ),
    usedIn: CATEGORIES.AFFORDABLE_HOUSING.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the indoor plumbing'
        }
      />
    ),
    description: (
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the lead paint dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for lead paint'
        }
      />
    ),
    usedIn: CATEGORIES.AFFORDABLE_HOUSING.METHODOLOGY,
  ...
  // Legacy pollution category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Abandoned mine lands'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Abandoned mine lands'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Formerly Used Defense Sites'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Formerly Used Defense Sites'
        }
      />
    ),
    usedIn: CATEGORIES.LEGACY_POLLUTION.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the prox haz dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for proximity to hazards'
        }
      />
    ),
    usedIn: CATEGORIES.LEGACY_POLLUTION.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the prox npl dataset'
        }
      />
    ),
    description: (
      <FormattedMessage
        ...
        `}
        description={
          'Navigate to the Methodology page. This is the description text for proximity to npl'
        }
      />
    ),
    usedIn: CATEGORIES.LEGACY_POLLUTION.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the prox rpm dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for proximity to rmp'
        }
      />
    ),
    usedIn: CATEGORIES.LEGACY_POLLUTION.METHODOLOGY,
  ...
  // Transportation category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the diesel pm dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for diesel pm'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Transportation barriers'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Transportation barriers'
        }
      />
    ),
    note: (
    ...
    `}
        description={
          'Navigate to the Methodology page. This is the note text for trans.barrier'
        }
        values={{
          boldtag: boldFn,
        }}
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the traffic.volume dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for traffic volume'
        }
      />
    ),
    usedIn: CATEGORIES.CLEAN_TRANSPORT.METHODOLOGY,
  ...
  // Water and wastewater category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Underground storage tanks and releases'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Underground storage tanks and releases'
        }
      />
    ),
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the waste water dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for waste water'
        }
      />
    ),
    usedIn: CATEGORIES.CLEAN_WATER.METHODOLOGY,
  ...
  // Workforce dev category:
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the linguistic isolation dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for linguistic isolation'
        }
      />
    ),
    note: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the note text for linguistic.iso'
        }
        values={{
          boldtag: boldFn,
        }}
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the low median income dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for workforce dev'
        }
      />
    ),
    note: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the note text for low median expectancy'
        }
        values={{
          boldtag: boldFn,
        }}
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the poverty dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for poverty'
        }
      />
    ),
    usedIn: CATEGORIES.WORKFORCE_DEV.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the unemployment dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for unemployment'
        }
      />
    ),
    usedIn: CATEGORIES.WORKFORCE_DEV.METHODOLOGY,
  ...
  },
  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the high school dataset'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for high school'
        }
      />
    ),
    usedIn: CATEGORIES.WORKFORCE_DEV.METHODOLOGY,
...

  {
    ...
    indicator: (
      <FormattedMessage
        ...
        description={
          'Navigate to the Methodology page. This is the title text for the Tribal lands'
        }
      />
    ),
    description: (
      ...
      `}
        description={
          'Navigate to the Methodology page. This is the description text for Tribal lands'
        }
      />
    ),
    note: (
...
export const RETURN_TO_TOP = {
  LINK: (
    <FormattedMessage
      ...
      description={
        'Navigate to the Methodology page. This is the link text to return to top'
      }
    />
  ),
};
